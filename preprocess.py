...
def save_image(image, filename, path="."):
  """
  Saves an image to a specidef face_comparison(image1_path, image2_path, model_name = 'deepface'):
    ...
    return is_verifiedfied path with the given filename.
...
# extract_id_card('/home/sunny/Desktop/e-KYC_cv/e-kc/eKYC/pan.png')
